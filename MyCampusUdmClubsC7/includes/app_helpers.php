...
function getMainAdminId(PDO $pdo): ?int
{
    $emailAdminPrincipal = 'vavymato@gmail.com'; // <-- remplace ici
...
function createNotification(PDO $pdo, int $userId, string $title, string $message, string $type = "systeme"): void
{
    ...
    $typesAutorises = ["adhesion", "evenement", "newsletter", "role", "systeme", "profil", "message"];
