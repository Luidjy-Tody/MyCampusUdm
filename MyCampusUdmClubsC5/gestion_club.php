...
<section class="carte">
  ...
  <form method="post" action="insert_club.php">
    ...
    <p class="texte-gris petit">
      Tout nouveau club est créé avec le statut <strong>En attente</strong> et doit être validé par l’administrateur.
    </p>
...
<section class="carte">
  ...
  <p class="texte-gris">
    Vous pouvez envoyer un message privé à l’administrateur pour toute demande officielle,
    par exemple pour faire valider votre statut de responsable.
  </p>

  <div class="carte-actions">
    <a class="bouton" href="contact_admin.php">
