...
<header class="barre-haut">
    <div class="conteneur nav">
        ...
        <nav class="menu">
            <?php if ($estAdmin) : ?>
                <a href="admin.php" class="nav-link"><i class="fas fa-shield-alt nav-icon"></i><span>Administration</span></a>
                <a href="newsletter_admin.php" class="nav-link"><i class="fas fa-envelope nav-icon"></i><span>Newsletter</span></a>
            <?php else : ?>
                <a href="<?= $clubsHref ?>" class="nav-link"><i class="fas fa-users nav-icon"></i><span>Clubs</span></a>
                <a href="<?= $calendrierHref ?>" class="nav-link"><i class="fas fa-calendar-alt nav-icon"></i><span>Calendrier</span></a>
                <?php if (isset($_SESSION["id"])) : ?>
                    <a href="<?= $tableauHref ?>" class="nav-link"><i class="fas fa-chart-bar nav-icon"></i><span>Tableau de bord</span></a>
                <?php endif; ?>
                <?php if (isset($_SESSION["role"]) && $_SESSION["role"] === "responsable") : ?>
                    <a href="gestion_club.php" class="nav-link"><i class="fas fa-cog nav-icon"></i><span>Mes clubs</span></a>
                    <a href="gestion_evenements.php" class="nav-link"><i class="fas fa-star nav-icon"></i><span>Événements</span></a>
                <?php endif; ?>
            <?php endif; ?>
        </nav>
        <div class="actions">
            <?php if (isset($_SESSION["id"])) : ?>
                <div class="profile-menu-wrap" id="profileMenuWrap">
                    <button type="button" class="profile-trigger" id="profileMenuTrigger" aria-haspopup="true" aria-expanded="false" aria-controls="profileDropdown" title="Ouvrir le menu profil">
                        <?php if ($photoExists) : ?>
                    ...
                    <div class="profile-dropdown" id="profileDropdown" hidden>
                        ...
                        <div class="profile-dropdown-actions">
                            <a href="profil.php" class="profile-dropdown-link">
